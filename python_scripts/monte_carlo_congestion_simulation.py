...
plt.legend()
plt.tight_layout()
plt.savefig(f"{PLOTS_DIR}/4_MC_simulation_congestion_vs_ev.png")
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig(f"{PLOTS_DIR}/5_MC_simulation_congestion_vs_pv.png")
plt.show()
...
plt.tight_layout()
plt.savefig(f"{PLOTS_DIR}/6_MC_simulation_congestion_heatmap.png")
plt.show()
...
plt.tight_layout()
plt.savefig(f"{PLOTS_DIR}/7_MC_simulation_example_load_profiles.png")
plt.show()